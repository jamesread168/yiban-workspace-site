...
const PICTURE_BOOKS = [
  ...
  { id: 'kb3', title: '小巴掌童话', author: '张秋生', emoji: '✋', group: '课内作家', sub: '童话类', desc: '短小精悍的童话，语言优美，非常适合朗读。', guide: '选一篇大声朗读给家人听。' },
  ...
  // —— 拓展阅读 ——
  { id: 'kb6', title: '小巴掌童话', author: '张秋生', emoji: '✋', group: '拓展阅读', sub: '童话', desc: '短小精悍的童话，语言优美，非常适合朗读。', guide: '选一篇大声朗读给家人听。' },
  { id: 'kb7', title: '365夜故事', author: '鲁兵 主编', emoji: '🌙', group: '拓展阅读', sub: '故事', desc: '一天一个故事，365 夜陪伴入眠的经典故事集。', guide: '睡前读一篇，读完说说道理。' },
  { id: 'kb8', title: '小猪唏哩呼噜', author: '孙幼军（小布头丛书）', emoji: '🐷', group: '拓展阅读', sub: '童话', desc: '唏哩呼噜是只不平凡的小猪，善良勇敢又有点迷糊。', guide: '聊聊唏哩呼噜做过哪些傻事。' },
  { id: 'kb9', title: '六个子老鼠小个子猫', author: '周锐', emoji: '🐭', group: '拓展阅读', sub: '童话', desc: '大个子老鼠真诚善良，小个子猫美丽温柔，暖心友情故事。', guide: '聊聊好朋友是怎么互相帮助的。' },
  { id: 'kb10', title: '小老虎历险记', author: '汤素兰', emoji: '🐯', group: '拓展阅读', sub: '童话', desc: '小老虎离开妈妈后的冒险成长故事。', guide: '猜一猜小老虎会遇到什么。' },
  { id: 'kb11', title: '亲爱的笨笨猪', author: '杨红樱', emoji: '🐷', group: '拓展阅读', sub: '童话', desc: '笨笨猪虽然笨，却用真诚和善良赢得大家的喜爱。', guide: '讨论：聪明和善良哪个更重要？' },
  { id: 'kb12', title: '吃黑夜的大象', author: '白冰', emoji: '🐘', group: '拓展阅读', sub: '童话', desc: '怕黑夜的孩子请大象把黑夜吃掉，结果……适合睡前读。', guide: '聊聊：没有黑夜会怎样？' },
  { id: 'kb13', title: '团圆', author: '余丽琼 / 朱成梁', emoji: '🥟', group: '拓展阅读', sub: '绘本', desc: '春节爸爸回家，一枚好运硬币串起父女深情。中国原创绘本。', guide: '讲讲你家过年的习俗。' },
  { id: 'kb14', title: '猜猜我有多爱你', author: '山姆·麦克布雷尼', emoji: '🐰', group: '拓展阅读', sub: '绘本', desc: '小兔子想告诉大兔子它有多爱他，一场爱的比拼。', guide: '和孩子比一比「我爱你这么多」。' },
  { id: 'kb15', title: '大卫去上学', author: '[美]大卫·香农', emoji: '🏫', group: '拓展阅读', sub: '绘本', desc: '大卫上学啦，学校里哪些能做哪些不能做？', guide: '和一年级校园生活对照着聊。' },
  { id: 'kb16', title: '落叶跳舞', author: '[日]伊东宽', emoji: '🍂', group: '拓展阅读', sub: '绘本', desc: '落叶拼出各种小人和动物，随风起舞的秋天绘本。', guide: '捡落叶拼一幅自己的画。' },
  { id: 'kb17', title: '小黄和小蓝', author: '[美]李欧·李奥尼', emoji: '💛', group: '拓展阅读', sub: '绘本', desc: '小黄和小蓝抱在一起变成了绿色，色彩启蒙经典。', guide: '玩一玩颜色混合游戏。' },
  { id: 'kb18', title: '中国古代神话故事', author: '选编本', emoji: '🐉', group: '拓展阅读', sub: '神话', desc: '盘古开天、女娲补天、后羿射日……中华文明起源的故事。', guide: '选一个神话讲给家人听。' },

  // —— 共读（深圳一年级上学期） ——
  { id: 'kb19', title: '萝卜回来了', author: '（中）方轶群 / 严个凡', emoji: '🥕', group: '共读', sub: '绘本', desc: '大雪天小兔子把萝卜送给朋友，萝卜转了一圈又回到自己家。', guide: '聊聊：小动物们为什么都把萝卜让给别人？' },
  { id: 'kb20', title: '小老鼠又上灯台喽', author: '（中）袁晓峰 / 赵晓音', emoji: '🐭', group: '共读', sub: '绘本', desc: '经典童谣新编，小老鼠们爬灯台偷油吃的逗趣故事。', guide: '和孩子一起念童谣，拍手打节奏。' },
  { id: 'kb21', title: '迟到的理由', author: '（中）姚佳', emoji: '⏰', group: '共读', sub: '绘本', desc: '小猪上学迟到编了一个又一个理由，最后诚实最重要。', guide: '讨论：做错事要不要说真话？' },
  { id: 'kb22', title: '别让太阳掉下来', author: '（中）郭振媛 / 朱成梁', emoji: '☀️', group: '共读', sub: '绘本', desc: '小动物们想办法托住下山的太阳，充满童趣的想象。', guide: '问孩子：太阳真的会掉下来吗？' },
  { id: 'kb23', title: '同一个月亮', author: '（中）幾米', emoji: '🌕', group: '共读', sub: '绘本', desc: '幾米笔下的月亮故事，温柔诗意，适合睡前共读。', guide: '抬头看看今晚的月亮像什么。' },
  { id: 'kb24', title: '跑跑镇', author: '（中）亚东 / 麦克小奎', emoji: '🏃', group: '共读', sub: '绘本', desc: '跑跑镇的居民跑着跑着撞在一起，撞出奇妙组合！', guide: '猜一猜：两个东西撞在一起会变成什么？' },
  { id: 'kb25', title: '林桃奶奶的桃子树', author: '（中）汤姆牛', emoji: '🍑', group: '共读', sub: '绘本', desc: '林桃奶奶把桃子分享给动物们，之后发生神奇的事。', guide: '聊聊分享带来的快乐。' },
  { id: 'kb26', title: '再来一只老鼠', author: '（美）约瑟夫·洛 / 白鸥', emoji: '🐀', group: '共读', sub: '绘本', desc: '猫要吃老鼠，老鼠请来各种伙伴「助阵」的幽默故事。', guide: '猜一猜老鼠接下来会请谁帮忙。' },
  { id: 'kb27', title: '月亮，生日快乐', author: '（美）法兰克·艾许 / 高明美', emoji: '🎂', group: '共读', sub: '绘本', desc: '小熊想送月亮生日礼物，山谷回声成了最好的回应。', guide: '对山谷喊一喊，听听回声。' },
  { id: 'kb28', title: '小蓝和小黄', author: '（美）李欧·李奥尼 / 彭懿', emoji: '🔵', group: '共读', sub: '绘本', desc: '小蓝和小黄抱在一起变成了绿色，色彩启蒙经典。', guide: '玩一玩颜色混合游戏。' },
  { id: 'kb29', title: '和甘伯伯去游河', author: '（英）约翰·伯宁罕 / 林良', emoji: '🚣', group: '共读', sub: '绘本', desc: '大家答应不闹却都闹了，甘伯伯还是不生气。', guide: '聊聊：甘伯伯为什么总是不生气？' },
  { id: 'kb30', title: '老狼，老狼，几点了', author: '（英）戴比·葛莉欧利 / 范晓星', emoji: '🐺', group: '共读', sub: '绘本', desc: '跟着老狼的一天认识时间，经典时间启蒙绘本。', guide: '玩「老狼老狼几点了」的游戏。' },
  { id: 'kb31', title: '母鸡萝丝去散步', author: '（英）佩特·哈群斯 / 信谊编辑部', emoji: '🐔', group: '共读', sub: '绘本', desc: '母鸡悠闲散步，身后的狐狸接连倒霉，图文反差经典。', guide: '只看图讲一讲狐狸的遭遇。' },
  { id: 'kb32', title: '落叶跳舞', author: '（日）伊东宽 / 蒲蒲兰', emoji: '🍂', group: '共读', sub: '绘本', desc: '落叶拼出小人和动物，随风起舞的秋天绘本。', guide: '捡落叶拼一幅自己的画。' },
  { id: 'kb33', title: '虎斑猫和黑猫', author: '（日）宫西达也 / 彭懿', emoji: '🐱', group: '共读', sub: '绘本', desc: '两只猫互相较劲，宫西达也式温情结尾。', guide: '聊聊：吵架后怎么和好？' },
  { id: 'kb34', title: '蚂蚁和西瓜', author: '（日）田村茂 / 蒲蒲兰', emoji: '🍉', group: '共读', sub: '绘本', desc: '小蚂蚁们团结合作搬西瓜，画面充满细节趣味。', guide: '观察蚂蚁是怎么分工合作的。' },
  ...
  { id: 'kb41', title: '彩虹色的花', author: '（外）麦克·格雷涅茨', emoji: '🌸', group: '选读', sub: '绘本', desc: '彩虹色的花把花瓣送给需要帮助的小动物。', guide: '讨论分享带来的快乐。' },
  { id: 'kb42', title: '幸运的内德', author: '（外）', emoji: '🍀', group: '选读', sub: '绘本', desc: '内德的运气忽好忽坏，一场跌宕起伏的冒险。', guide: '猜一猜下一页是好运还是坏运。' },
  { id: 'kb43', title: '阿文的小毯子', author: '（外）凯文·亨克斯', emoji: '🧸', group: '选读', sub: '绘本', desc: '阿文走到哪都带着小毯子，如何温柔地帮他长大。', guide: '孩子有离不开的「宝贝」吗？' },
  { id: 'kb44', title: '我妈妈', author: '（外）安东尼·布朗', emoji: '👩', group: '选读', sub: '绘本', desc: '妈妈是厨师、是画家、是……也是永远爱你的妈妈。', guide: '聊聊妈妈每天为你做了哪些事。' },
  { id: 'kb45', title: '我爸爸', author: '（外）安东尼·布朗', emoji: '👨', group: '选读', sub: '绘本', desc: '用孩子的口吻描绘无所不能的爸爸，充满想象力与爱。', guide: '说说爸爸最厉害的地方。' },
  { id: 'kb46', title: '大卫，不可以', author: '（外）大卫·香农', emoji: '🙈', group: '选读', sub: '绘本', desc: '调皮的大卫总在闯祸，但妈妈依然爱他。', guide: '讨论哪些事「不可以」，为什么。' },
  { id: 'kb47', title: '不一样的小豆豆', author: '（外）', emoji: '🫘', group: '选读', sub: '绘本', desc: '每颗豆豆都不一样，不一样也很棒。', guide: '说说自己「不一样」的地方。' },
  { id: 'kb48', title: '想吃苹果的鼠小弟', author: '（日）中江嘉男', emoji: '🍎', group: '选读', sub: '绘本', desc: '鼠小弟够不到苹果，看动物们各显神通，鼠小弟系列。', guide: '学一学每种动物够苹果的样子。' },
  { id: 'kb49', title: '我喜欢自己', author: '（外）南希·卡尔森', emoji: '💗', group: '选读', sub: '绘本', desc: '一只会照顾自己、鼓励自己的小猪，自信启蒙。', guide: '说说自己最棒的三件事。' },
  { id: 'kb50', title: '我喜欢书', author: '（外）安东尼·布朗', emoji: '📚', group: '选读', sub: '绘本', desc: '胖胖的猩猩展示各种各样的书，阅读兴趣启蒙。', guide: '你最喜欢哪一类书？' },
