 ...
 */
const CACHE_NAME = 'yiban-workspace-v33';
const CORE_FILES = [
  './',
  './index.html?v=33',
  './manifest.json?v=33',
  ...
  './js/sync.js?v=33',
  './js/schedule.js?v=33',
  './js/schedule-edit.js?v=33',
  './js/study.js?v=33',
  './js/zi-stroke-data.js?v=33',
  './js/views.js?v=33',
  './js/cloud-sync.js?v=33',
  './js/materials.js?v=33',
  './js/exam.js?v=33',
  './js/review.js?v=33',
  './js/routine.js?v=33',
  './js/parent.js?v=33',
  './js/homework.js?v=33',
  './js/feedback.js?v=33',
  './js/lib/hanzi-writer.min.js?v=33',
  './js/app.js?v=33',
  './assets/icons/icon-192.png?v=33',
  './assets/icons/icon-512.png?v=33',
];
