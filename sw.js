 ...
 */
const CACHE_NAME = 'yiban-workspace-v40';
const CORE_FILES = [
  './',
  './index.html?v=40',
  './manifest.json?v=40',
  ...
  './js/sync.js?v=40',
  './js/schedule.js?v=40',
  './js/schedule-edit.js?v=40',
  './js/study.js?v=40',
  './js/zi-stroke-data.js?v=40',
  './js/views.js?v=40',
  './js/cloud-sync.js?v=40',
  './js/materials.js?v=40',
  './js/exam.js?v=40',
  './js/review.js?v=40',
  './js/routine.js?v=40',
  './js/parent.js?v=40',
  './js/homework.js?v=40',
  './js/feedback.js?v=40',
  './js/lib/hanzi-writer.min.js?v=40',
  './js/app.js?v=40',
  './assets/icons/icon-192.png?v=40',
  './assets/icons/icon-512.png?v=40',
];
