 ...
 */
const CACHE_NAME = 'yiban-workspace-v31';
const CORE_FILES = [
  './',
  './index.html?v=31',
  './manifest.json?v=31',
  ...
  './js/sync.js?v=31',
  './js/schedule.js?v=31',
  './js/schedule-edit.js?v=31',
  './js/study.js?v=31',
  './js/zi-stroke-data.js?v=31',
  './js/views.js?v=31',
  './js/cloud-sync.js?v=31',
  './js/materials.js?v=31',
  './js/exam.js?v=31',
  './js/review.js?v=31',
  './js/routine.js?v=31',
  './js/parent.js?v=31',
  './js/homework.js?v=31',
  './js/feedback.js?v=31',
  './js/lib/hanzi-writer.min.js?v=31',
  './js/app.js?v=31',
  './assets/icons/icon-192.png?v=31',
  './assets/icons/icon-512.png?v=31',
];
