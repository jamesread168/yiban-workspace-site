 ...
 */
const CACHE_NAME = 'yiban-workspace-v51';
const CORE_FILES = [
  './',
  './index.html?v=51',
  './manifest.json?v=51',
  ...
  './js/sync.js?v=51',
  './js/schedule.js?v=51',
  './js/schedule-edit.js?v=51',
  './js/study.js?v=51',
  './js/zi-stroke-data.js?v=51',
  './js/views.js?v=51',
  './js/cloud-sync.js?v=51',
  './js/materials.js?v=51',
  './js/exam.js?v=51',
  './js/review.js?v=51',
  './js/routine.js?v=51',
  './js/parent.js?v=51',
  './js/homework.js?v=51',
  './js/feedback.js?v=51',
  './js/lib/hanzi-writer.min.js?v=51',
  './js/app.js?v=51',
  './assets/icons/icon-192.png?v=51',
  './assets/icons/icon-512.png?v=51',
];
