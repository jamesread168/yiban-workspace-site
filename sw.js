 ...
 */
const CACHE_NAME = 'yiban-workspace-v32';
const CORE_FILES = [
  './',
  './index.html?v=32',
  './manifest.json?v=32',
  ...
  './js/sync.js?v=32',
  './js/schedule.js?v=32',
  './js/schedule-edit.js?v=32',
  './js/study.js?v=32',
  './js/zi-stroke-data.js?v=32',
  './js/views.js?v=32',
  './js/cloud-sync.js?v=32',
  './js/materials.js?v=32',
  './js/exam.js?v=32',
  './js/review.js?v=32',
  './js/routine.js?v=32',
  './js/parent.js?v=32',
  './js/homework.js?v=32',
  './js/feedback.js?v=32',
  './js/lib/hanzi-writer.min.js?v=32',
  './js/app.js?v=32',
  './assets/icons/icon-192.png?v=32',
  './assets/icons/icon-512.png?v=32',
];
