 ...
 */
const CACHE_NAME = 'yiban-workspace-v37';
const CORE_FILES = [
  './',
  './index.html?v=37',
  './manifest.json?v=37',
  ...
  './js/sync.js?v=37',
  './js/schedule.js?v=37',
  './js/schedule-edit.js?v=37',
  './js/study.js?v=37',
  './js/zi-stroke-data.js?v=37',
  './js/views.js?v=37',
  './js/cloud-sync.js?v=37',
  './js/materials.js?v=37',
  './js/exam.js?v=37',
  './js/review.js?v=37',
  './js/routine.js?v=37',
  './js/parent.js?v=37',
  './js/homework.js?v=37',
  './js/feedback.js?v=37',
  './js/lib/hanzi-writer.min.js?v=37',
  './js/app.js?v=37',
  './assets/icons/icon-192.png?v=37',
  './assets/icons/icon-512.png?v=37',
];
