 ...
 */
const CACHE_NAME = 'yiban-workspace-v38';
const CORE_FILES = [
  './',
  './index.html?v=38',
  './manifest.json?v=38',
  ...
  './js/sync.js?v=38',
  './js/schedule.js?v=38',
  './js/schedule-edit.js?v=38',
  './js/study.js?v=38',
  './js/zi-stroke-data.js?v=38',
  './js/views.js?v=38',
  './js/cloud-sync.js?v=38',
  './js/materials.js?v=38',
  './js/exam.js?v=38',
  './js/review.js?v=38',
  './js/routine.js?v=38',
  './js/parent.js?v=38',
  './js/homework.js?v=38',
  './js/feedback.js?v=38',
  './js/lib/hanzi-writer.min.js?v=38',
  './js/app.js?v=38',
  './assets/icons/icon-192.png?v=38',
  './assets/icons/icon-512.png?v=38',
];
