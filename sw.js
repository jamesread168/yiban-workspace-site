 ...
 */
const CACHE_NAME = 'yiban-workspace-v43';
const CORE_FILES = [
  './',
  './index.html?v=43',
  './manifest.json?v=43',
  ...
  './js/sync.js?v=43',
  './js/schedule.js?v=43',
  './js/schedule-edit.js?v=43',
  './js/study.js?v=43',
  './js/zi-stroke-data.js?v=43',
  './js/views.js?v=43',
  './js/cloud-sync.js?v=43',
  './js/materials.js?v=43',
  './js/exam.js?v=43',
  './js/review.js?v=43',
  './js/routine.js?v=43',
  './js/parent.js?v=43',
  './js/homework.js?v=43',
  './js/feedback.js?v=43',
  './js/lib/hanzi-writer.min.js?v=43',
  './js/app.js?v=43',
  './assets/icons/icon-192.png?v=43',
  './assets/icons/icon-512.png?v=43',
];
